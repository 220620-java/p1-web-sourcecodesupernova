...
public class ValidateData {
	...
	public static Boolean charType(String input, int size) {
		Boolean valid = true;
	 ...
	 * Also, if the input contains a ';' it would break the SQL*/
	public static Boolean varcharType(String input, int size) {
		Boolean valid = true;
		if (input.contains(";") || input.length() > size) {
			valid = false;
		}
	...
	public static Boolean textType(String input) {
		Boolean valid = true;
		if (input.contains(";")) {
			valid = false;
		}
	...
	public static Boolean integerType(String input) {
		Boolean valid = true;
		try {
	...
	public static Boolean decimalType(String input) {
		Boolean valid = true;
		try {
